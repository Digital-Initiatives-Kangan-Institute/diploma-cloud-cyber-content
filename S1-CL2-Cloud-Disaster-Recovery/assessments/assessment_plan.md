...
| **SR-CL2-04** | Provided AT2 artefacts as appendices — the data-store IaC template, the audit-log microservice code, the webhook contract | AT2 | [ICTCLD503 AC 4] |
| **SR-CL2-05** | A required-personnel stakeholder to role-play the AT1 Part C presentation feedback + design sign-off | AT1 | — |
| **SR-CL2-06** | Risk-event data + reporting standards for the DR plan | AT1 | [ICTCLD501 AC 1] · [ICTCLD501 AC 3] |
