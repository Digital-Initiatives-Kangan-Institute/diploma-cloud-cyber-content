...
(build_s1_cl3_at1_assessor) so the shared content is single-sourced and cannot drift. Loads the
...
import build_s1_cl3_at1_assessor as a  # noqa: E402  (cluster content)
