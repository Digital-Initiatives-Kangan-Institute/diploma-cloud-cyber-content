...
Usage:  python scripts/build_at2_baseline_solution_design.py [output.docx]
...
def build(path):
    ...
    ex.para(doc, "This document specifies the baseline AWS architecture MTS will implement as the first "
